...
public class OrderTests {
    ...
    private static Stream<Arguments> orderDetailsMandatoryFields() {
        return Stream.of(
                Arguments.of("Иван", "Иванов", "Красная Площадь", "Черкизовская", "+79818370000", "22.11.2025", "сутки"),
    ...
    private static Stream<Arguments> orderDetailsAllFields() {
        return Stream.of(
                Arguments.of("Иван", "Иванов", "Красная Площадь", "Черкизовская", "+79818370000", "01.12.2026", "двое суток", "black", "Мне нужен твой мотоцикл"),
